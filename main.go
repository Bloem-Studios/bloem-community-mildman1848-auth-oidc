...
import (
	...
	"github.com/Bloem-Studios/bloem-community-mildman1848-auth-oidc/internal/provider"
...
func loadManifest() (*pluginv1.PluginManifest, error) {
	...
	data = []byte(strings.ReplaceAll(string(data), "\"version\": \"0.1.4\"", fmt.Sprintf("\"version\": \"%s\"", version)))
